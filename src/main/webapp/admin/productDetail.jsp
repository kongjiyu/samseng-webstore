            ...
            <div class="w-full lg:w-1/3 p-10 space-y-4">
                ...
                <div class="card bg-base-100 shadow-md p-4 space-y-4">
                    <div id="horizontal-thumbnails" data-carousel class="relative w-full">
                      <div class="carousel">
                        <div class="carousel-body h-72 opacity-0">
                          <%
                            HashSet<String> imageSet = ((Product) request.getAttribute("product")).getImageSet();
                            for (String image : imageSet) {
                          %>
                            <div class="carousel-slide">
                              <div class="flex size-full justify-center">
                                <img src="/uploads/<%= image %>" class="object-contain max-h-72" alt="product image" />
                              </div>
                            </div>
                          <%
                            }
                        ...
                        <div class="carousel-pagination bg-base-100 absolute bottom-0 end-0 start-0 z-1 h-16 flex justify-center gap-2 overflow-x-auto pt-2">
                          <%
                            for (String image : imageSet) {
                          %>
                            <img src="/uploads/<%= image %>" class="carousel-pagination-item carousel-active:opacity-100 grow object-cover opacity-30 h-12" alt="thumb" />
                          <%
                            }
                          %>
                        </div>
