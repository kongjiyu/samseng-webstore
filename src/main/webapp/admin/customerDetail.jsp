              ...
              <form method="post" action="<%= request.getContextPath() %>/admin/control" class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" class="input input-bordered w-full" value="<%=account.getId()%>" disabled />
                  </div>
                  <div>
                    <label class="label">Username</label>
                    <input type="text" class="input input-bordered w-full" name="username" value="<%=account.getUsername()%>" />
                  </div>
                  <div>
                    <label class="label">Date of Birth</label>
                    <input type="date" class="input input-bordered w-full" name="dob" value="<%=account.getDob()%>" />
                  </div>
                  <div>
                    <label class="label">Email</label>
                    <input type="email" class="input input-bordered w-full" name="email" value="<%=account.getEmail()%>" />
                  </div>
                  <div>
                    <label class="label">Role</label>
                    <select class="select w-full appearance-none" name="role" required>
                      <option value="USER" <%= account.getRole() == Account.Role.USER ? "selected" : "" %>>User</option>
                      <option value="STAFF" <%= account.getRole() == Account.Role.STAFF ? "selected" : "" %>>Staff</option>
                      <option value="ADMIN" <%= account.getRole() == Account.Role.ADMIN ? "selected" : "" %>>Admin</option>
                    </select>
                  </div>
                </div>
